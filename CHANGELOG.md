...
- **add global background** (`032c457`) - *Qwenzy*
  - 📁 1 doc file, 1 config file, 8 frontend files, 1 backend file
  - 📊 *Medium change (9 files)*
...
- Refactor code structure for improved readability and maintainability (`462318d`) - Qwenzy
